interface IDynamicTextAnimationNumber {
    from: number
    to: number
    duration: number
}

interface IDynamicTextAnimationVector2 {
    from: Vector2
    to: Vector2
    duration: number
}

class DynamicTextAnimationNumber {
    timer: number
...
class DynamicTextAnimationVector2 {
    timer: number
...
interface DynamicTextAnimation {
